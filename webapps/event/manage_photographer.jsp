...
<tr>
	<td>
		<form method='post' action='manage_photographer.jsp' name='reg' onsubmit='return validate()'>
		<table width='100%' height='100%' class='admin'>
		<tr>
			<td align='right' class='text'><b>Photographer Name:</b></td>
...
<tr>
	...
	<tr>
		...
		<td align='center'><a href='delete_photographer.jsp?cid=<%=rs.getString(1)%>' class='opr'>Delete</a></td>
		<td align='center' style='padding:15px;'><a href='update_photographer.jsp?cid=<%=rs.getString(1)%>' class='opr'>Update</a></td>
	</tr>
	<%
		}
	%>
