...
<form method='post' action='edit_cust_profile.jsp' name='reg' onsubmit='return validate()'>
<table width='100%' height='100%' class='admin'>
<tr>
	<td colspan=2 align='center'><a href='cust_home.jsp'><img src='images/users.jpg' width=300 height=300/></a></td>
</tr>
<tr>
	<td align='right' class='text'><b>Customer ID:</b></td>
	<td><input type='text' name='cid' class='text' required onfocus='change(this)' onblur='unchange(this)' value='<%=rs.getString(1)%>' readOnly></td>
</tr>
<tr>
	<td align='right' class='text'><b>Customer Password:</b></td>
	<td><input type='password' name='pwd' class='text' required onfocus='change(this)' onblur='unchange(this)' value='<%=rs.getString(2)%>'></td>
</tr>
<tr>
	<td align='right' class='text'><b>Name:</b></td>
	<td><input type='text' name='name' class='text' required onfocus='change(this)' onblur='unchange(this)' value='<%=rs.getString(3)%>'></td>
</tr>
<tr>
	<td align='right' class='text'><b>Address:</b></td>
	<td><textarea name='addr' class='text' required onfocus='change(this)' onblur='unchange(this)' rows=4 cols=50><%=rs.getString(4)%></textarea></td>
</tr>
<tr>
